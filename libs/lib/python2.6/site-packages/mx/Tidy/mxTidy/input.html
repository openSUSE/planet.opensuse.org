	...
	<TR>
	  <TD>
	    <SMALL>
	      ...
	      <A HREF="http://www.lemburg.com/files/python/eGenix-mx-Extensions.html#Download-mxBASE"><B>Download</B></A> :
...
>>> NextTuesday = RelativeDateTime(days=+6,weekday=(Tuesday,0))
	...
	<P><DL>
	  ...
	  <DT><CODE><FONT COLOR="#000099">
		DateTimeFromString(text) </FONT></CODE></DT>
	  ...
	  <DT><CODE><FONT COLOR="#000099">
		DateFromString(text) </FONT></CODE></DT>
...
[DateTime]
    ...
    <UL CLASS="indent">
      ...
      <P><UL>
	    ...
	    <P><LI> Add 'AM/PM' support to the Parser module.
	  ...
	  HREF="mxDateTime-1.3.0.zip">1.3.0</A> to 2.0.0:
	  ...
	  digit years to not fail parsing.
	    ...
	    Thanks to Jean-François Piéronne for the patches. He also
      ...
      <P>Things that changed from <A
	  HREF="mxDateTime-1.2.0.zip">1.2.0</A> to 1.3.0:

      <P><UL>

	<LI>Added a set of new constructors needed to ease use of
	  mxDateTime for <A
            HREF="http://www.lemburg.com/files/python/DatabaseAPI-2.0.html">DB
      ...
      <P>Things that changed from <A
	  HREF="mxDateTime-1.1.0.zip">1.1.0</A> to 1.2.0:
	...
	<LI>Fixed a few typos in the Feasts and Locale
      ...
      <P>Things that changed from <A
	  HREF="mxDateTime-1.0.0.zip">1.0.1</A> to 1.1.0:
	...
	<LI>Fixed the hour range check to not accept 24 as input
      ...
      <P>Things that changed from <A
	  HREF="mxDateTime-1.0.0.zip">1.0.0</A> to 1.0.1:
	...
	<LI>Added optional tz keyword parameter to ISO.str and
      ...
      <P>Things that changed from <A
	  HREF="mxDateTime-0.9.2.zip">0.9.2</A> to 1.0.0:
	...
	<LI>Changed the <B>DateTime_AsTmStruct() C API</B>. You
      ...
      <P>Things that changed from <A
	  HREF="mxDateTime-0.9.1.zip">0.9.1</A> to 0.9.2:
	...
	<LI>Documented (and changed) the tz_offset() helper
      ...
      <P>Things that changed from <A
	  HREF="mxDateTime-0.9.0.zip">0.9.0</A> to 0.9.1:
